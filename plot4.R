...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("Black","Red","Blue"),
       lty=1,cex=0.55,bty="n")

#plot 3, upper right
plot(HPC_slim$Date.time,HPC_slim$Voltage,type="l",xlab="datetime",ylab="Voltage",col="black",cex.lab=0.7)

#plot4, lower right
plot(HPC_slim$Date.time,HPC_slim$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power",
     col="black",cex.lab=0.7)
